...
const experienceInfoArray: ExperienceInfo[] = [
  {
    ...
    text: "I decided it was time to change my job and find out what it's like to work in another company. So I joined a team in Raiffeisen Bank and now have been working on some internal products for managers. Our solutions help them to do budget distribution, increase employees salaries and divide bonuses between teammates.",
  },
  {
    isOpen: false,
    year: "2019",
    title: "Started doing front-end",
    text: "I realized that I'm actually very interested in front-end development. So, besides back-end tasks, I started working with an old and ugly CRM UI for MTS operators. I started developing a React components library and made a new web app with React, Redux and TypeScript. I hope I set the direction of web development in a team and there will be good UI.",
  },
  {
    isOpen: false,
    year: "2018",
    title: "Became a back-end developer",
    text: "I'd learned the product good enough to develop myself so I started doing back-end development. There was a big refactoring task I was responsible for, and that was a knotty problem. I had to not only rewrite old code with new technologies but also scale the solution and deal with highload. And I managed it!",
  },
  {
    isOpen: false,
    year: "2017",
