...
const experienceInfoArray: ExperienceInfo[] = [
  {
    ...
    text: "I decided it was time to change my job and find out what it's like to work in another company. So I joined a team in Raiffeisen Bank and now have been working on some internal products for managers. Our solutions help them to do budget distribution, increase employees salaries and divide bonuses between teammates. For now I have integrated Redux to our apps which was quite useful. Also we completely redesigned our salary increasing and bonuses dividing apps and created a handy admin tools. All this helped us to flexibly set up and launch the 2022 processes. We received a lot of positive feedback from users, so we are very happy now :)",
  },
  {
    isOpen: false,
    year: "2018",
